<div class="container p-3">
    <div class="col-lg-6 col-md-8 col-sm-10 col-12 m-auto" style="background-color: #fff; border-radius: 3px;"><br><br>
        <div class="logo text-center mb-3">
            <h2><span class="text-danger"><i class="fa fa-book"></i> </span>Online Library</h2>
        </div>
        <form action="thanks.php" class="p-4">
            <div class="form-group">
                <label for="text" class="font-weight-bold text-white">Name</label>
